...
def rotate_and_change(vis):
    ...
    if params.counter == 0:
        ...
        voxel_grid=o3d.geometry.VoxelGrid.create_from_point_cloud(pcd,voxel_size=params.voxel_sizes[-1])
    ...
    # point_cloud_path = 'bunnyStatue.txt'
...
if( __name__ == "__main__" ):
    ...
    if( bunny ):
        print('BUNNY FOR REAL')
        points = np.load("points_bunny.npy")
        colors = np.load("colors_bunny.npy")
        normals = np.load("normals_bunny.npy")
    else:
